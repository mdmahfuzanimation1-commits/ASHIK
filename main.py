...
# =============================================
# ২. ডিফল্ট কনফিগ (৪টি সার্ভিস ও ৪টি দেশ)
# =============================================
DEFAULT_CONFIG = {
    "is_active": True,
    "interval": 3,
...
async def send_otp_message(bot, config):
    try:
        ...
        keyboard = [
            [InlineKeyboardButton(code, callback_data="otp_code", style="success")],   # 🟢 সবুজ
            [InlineKeyboardButton("📞 Number Bot", url="https://t.me/TrustOTP_Official_bot", style="primary")],  # 🔵 নীল
            [InlineKeyboardButton("📢 Main Channel", url="https://t.me/trustotpmethod", style="primary")]        # 🔵 নীল
        ]
...
# =============================================
# ১০. মেসেজ হ্যান্ডলার (ইনপুট নেওয়ার জন্য)
# =============================================
...
def main():
    ...
    app.run_polling(allowed_updates=[], timeout=60)
...
async def send_otp_message(bot, config):
    try:
        ...
        code = generate_random_code()
        keyboard = [
            [InlineKeyboardButton(code, callback_data="otp_code")],
            [InlineKeyboardButton("📞 Number Bot", url="https://t.me/TrustOTP_Official_bot")],
            [InlineKeyboardButton("📢 Main Channel", url="https://t.me/trustotpmethod")]
        ]
        await bot.send_message(
            chat_id=GROUP_CHAT_ID,
            text=text,
